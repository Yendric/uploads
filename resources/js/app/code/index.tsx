...
export default function CodeIndex({ files }: FileIndexProps) {
    const { open: writeCodeModal } = useModal(WriteCodeModal, {});
    ...
    return (
        <>
            ...
            <div className="flex items-center justify-between">
                ...
                <Button onClick={writeCodeModal} variant="secondary">
